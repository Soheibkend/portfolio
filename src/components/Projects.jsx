...
const Projects = () => {
    ...
    return (
        ...
        <div className="mt-14 h-full" id="projects">
            ...
            <div className="" style={{paddingTop:"30px", paddingBottom:"100px"}}>
                <a href="https://github.com/Soheibkend?tab=repositories" target="_blank" rel="noreferrer" className="group text-slate-200 font-semibold tracking-wide duration-200 hover:text-[#64ffda]">
                    <span>
                        View All Projects
