...
const SocialMedia = () => {
    return (
        <ul className="flex items-center">
            <li className=" mr-6 hover:text-[#64ffda]">
                <a href="https://github.com/Soheibkend" target="_blank">
            ...
            <li className=" mr-6 hover:text-[#64ffda]">
                <a href="https://www.linkedin.com/in/soheib-kendjouh/" target="_blank">
            ...
            <li className=" mr-6 hover:text-[#64ffda]">
                <a href="https://codepen.io/soheibkend" target="_blank">
            ...
            <li className=" mr-6">
                <a href="https://www.instagram.com/_so.he.ib_/" target="_blank" className=" hover:text-[#64ffda]">
