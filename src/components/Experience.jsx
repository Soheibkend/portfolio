...
const Experience = () => {
    return (
        ...
        <div className="mt-14 ">
            ...
            <div className="pb-10">
                <a href="https://drive.google.com/file/d/1335vXpysrPShWjuCLb2FHjqfU__jRMFU/view?usp=sharing" target="_blank" rel="noreferrer" className="group pb-11 text-slate-200 font-semibold tracking-wide duration-200 hover:text-[#64ffda]">
                    <span>
                        View Full Resume
